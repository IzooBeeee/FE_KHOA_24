        ...
        <div class="receipt-container">
            <div class="receipt-paper">
                ...
                <div class="receipt-header">
                    <div class="logo-section">
                        <div class="logo-circle">
                            <img src="https://dzfullstack.com/assets/images/logo-1.png" alt="DZCinema Logo" class="logo-img">
                        </div>
                        <h1 class="company-name">DZCINEMA</h1>
                ...
                <div class="qr-section">
                    <div class="qr-box">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=DZCinema-20241225-F08F09-SpiderManNoWayHome&format=png"
                            alt="QR Code" class="qr-code">
                    </div>
                    <p class="qr-text">Quét mã để xác thực</p>
                </div>
                ...
                <div class="transaction-section">
                    <div class="trans-row">
                        <span>Thời gian:</span>
                        <span>25/12/2024 18:42:15</span>
                    </div>
                    <div class="trans-row">
                        <span>Mã GD:</span>
                        <span>DZ-20241225-184215-001</span>
                    </div>
                </div>
                ...
                <div class="receipt-footer">
                    ...
                    <p class="website">www.dzcinema.vn</p>
                </div>
