											...
											<div class="row align-items-center g-3">
												...
												<div class="col-md-6">
													...
													<div class="mb-2">
														...
														<span v-if="order.is_thanh_toan" class="badge bg-success">
													...
													<div class="text-md-end">
														...
														<div class="mb-3">
															<div class="text-muted small mb-1">
																<del v-if="order.giam_gia > 0">{{ formatVND(order.tong_tien) }}</del>
															</div>
		...
		<div class="modal-dialog modal-xl">
			<div class="modal-content" v-if="selectedOrder">
					...
					<div class="row">
							...
							<div class="card">
								...
								<div class="card-body" v-if="selectedOrder.phim">
									<div class="text-center mb-3">
										<img :src="selectedOrder.phim.hinh_anh" alt="Movie" class="img-fluid rounded" style="max-height: 300px;">
									</div>
						...
						<div class="col-lg-7">
							...
							<div class="card mb-3">
								...
								<div class="card-body" v-if="selectedOrder.danh_sach_ghe && selectedOrder.danh_sach_ghe.length > 0">
									<div class="d-flex flex-wrap gap-2">
										<span v-for="ghe in selectedOrder.danh_sach_ghe" 
											:key="ghe"
							...
							<div class="card">
								...
								<div class="card-body">
									<table class="table table-borderless mb-0">
										<tr>
											<td>Tổng tiền:</td>
											<td class="text-end"><strong>{{ formatVND(selectedOrder.tong_tien) }}</strong></td>
										</tr>
										<tr v-if="selectedOrder.giam_gia > 0" class="text-success">
											<td>Giảm giá:</td>
											<td class="text-end"><strong>-{{ formatVND(selectedOrder.giam_gia) }}</strong></td>
										</tr>
										<tr class="border-top">
											<td class="fs-5"><strong>Thành tiền:</strong></td>
											<td class="text-end fs-4 text-danger"><strong>{{ formatVND(selectedOrder.tien_thuc_nhan) }}</strong></td>
										</tr>
									</table>
								</div>
							</div>
				...
				<div class="modal-footer">
					...
					<button v-if="!selectedOrder.is_thanh_toan" 
							type="button" 
